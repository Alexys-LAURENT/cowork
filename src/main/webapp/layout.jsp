...
<body class='flex flex-col w-full justify-center bg-[#F7F7F9]'>
    <header class='w-full flex justify-center bg-white '>
        <nav class='w-full max-w-[1300px] flex flex-col md:flex-row items-center p-2 gap-2 md:gap-0'>
        	...
        	<ul class='list-none flex flex-col md:flex-row gap-4 items-center justify-center text-base text-cow_text'>
        	<li>
        	Accueil
        	</li>
        	<li>
        	...
        	<button class='bg-cow_secondary w-full md:w-auto rounded-sm text-white px-4 py-2 font-semibold '>Se connecter</button>
        	</div>
        </nav>
    </header>
